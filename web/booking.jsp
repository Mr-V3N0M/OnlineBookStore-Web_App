...
<head>
    ...
    <meta name="description" content="Prenotazione di un libro su Online BookStore">
    <meta name="author" content="Fabio Somaglia">
    <title>Prenotazione - Online BookStore</title>
    <!-- Bootstrap CSS -->
...
<jsp:include page="Controller">
    <jsp:param name="action" value="booking"/>
</jsp:include>
            ...
            <div class="col-12">
                ...
                <c:if test="${requestScope.errorBooking != null}">
                    <div class="alert alert-danger alert-dismissible fade show col-8 offset-2" role="alert">
                        ...
                        <strong>Oh no!</strong> Abbiamo riscontrato dei problemi a prenotare il tuo libro. Riprovare più tardi. Grazie.
                    </div>
                </c:if>
                <h6 class="mb-3">Per prenotare un libro, selezionalo e in basso compariranno i dati riepilogativi del
                    libro selezionato. Verificare che le informazioni siano corrette e fare click su "Prenota". Buona
                    lettura :)</h6>
                <!-- DataTables for all available books -->
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fa fa-fw fa-table"></i>Libri disponibili per il prestito
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table booking table-bordered table-hover" id="allAvailableBooks" width="100%"
                                   cellspacing="0">
                                <thead>
                                <tr>
                                    <th>ID Libro</th>
                                ...
                                <c:forEach items="${requestScope.allAvailableBook}" var="book">
                                    <tr>
                ...
                <div id="containerFormBooking" class="mb-3">
                    <h4>Libro selezionato:</h4>
                    <form action="Controller" method="post" id="formBooking" class="form-inline">
                        ...
                        <button type="submit" class="btn btn-primary" name="action" value="booked">Prenota</button>
                    </form>
                </div>
            </div>
        </div>
