...
<head>
    ...
    <meta name="description" content="Cronologia dei prestiti su Online BookStore">
    <meta name="author" content="Fabio Somaglia">
    <title>Cronologia Prestiti - Online BookStore</title>
    <!-- Bootstrap CSS -->
...
<jsp:include page="Controller">
    <jsp:param name="action" value="booking-user"/>
</jsp:include>
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Cronologia dei prestiti</li>
        </ol>
        <div class="row">
            <div class="col-12">
                <h1>Cronologia dei prestiti attivi e passati</h1>
                <hr>
            </div>
            <br>

            <div class="col-12">
                <h6 class="mb-3">In questa sezione potrai vedere tutti i prestiti attivi e passati da te effettuati. L'ordine di visualizzazione di default è temporale discendente, questo significa che le prenotazioni più recenti sono in cima.</h6>
                <!-- Nav tabs -->
                <ul id="tabBookingUser" class="nav nav-pills" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#pa" role="tab">Prestiti attivi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="pill" href="#pp" role="tab">Prestiti passati</a>
                    </li>
                </ul>
                <!-- Tab panes -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table booked table-bordered table-hover" id="booked" width="100%" cellspacing="0">
                                        ...
                                        <c:forEach items="${requestScope.activeBookingUser}" var="activeBooking">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table returned table-bordered table-hover" id="endBooked" width="100%" cellspacing="0">
                                        ...
                                        <c:forEach items="${requestScope.endedBookingUser}" var="endedBooking">
                                            <tr>
